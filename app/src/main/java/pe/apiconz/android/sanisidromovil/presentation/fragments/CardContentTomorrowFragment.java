 ...
 */
public class CardContentTomorrowFragment extends BaseFragment {

    protected RecyclerView recyclerView;
    private String TAG = CardContentTomorrowFragment.class.getCanonicalName();
    private ActivityAdapter adapter;


    @Override
    protected void onCreatedView() {
        List<EventEntity> list = (List<EventEntity>) getArguments().get("nextDayActivities");
    ...
    protected int getResourceLayout() {
        return R.layout.recycler_view2;
    }
}
