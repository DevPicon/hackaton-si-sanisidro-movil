 ...
 */
public class CardContentAllFragment extends BaseFragment {

    protected RecyclerView recyclerView;
    private String TAG = CardContentAllFragment.class.getCanonicalName();
    private ActivityAdapter adapter;


    @Override
    protected void onCreatedView() {
        List<EventEntity> list = (List<EventEntity>) getArguments().get("soonActitivies");
    ...
    protected int getResourceLayout() {
        return R.layout.recycler_view3;
    }
}
